...
results_dir <-paste("/home/leroy/Desktop/PROJECTS/dmrscaler_real_data/results2/SOTOS/")
...
temp <- quantile(log10(combp_results_100k_10k$end - combp_results_100k_10k$start), seq(0.01,1,by=0.01), type=1)
quants <- rbind(quants, data.frame(percentile = seq(0.01,1,by=0.01), value = temp,
                                     method = "combp",pars="combp:dist=100kb,step=10kb"))
