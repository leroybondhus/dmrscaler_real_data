...
ds_id <- grep("Sex", names(data_set_list), invert = T)
result_set_ids <- grep(paste("data_set_", data_set_id, sep = ""), names(data_set_results))
for(ds_id in data_set_ids){
...
clean_results_table <- tab_spanner(clean_results_table,
                                   columns = c("num_dmrs","mean_width","median_width", "percent_total_width") )
