...
data_set_regions_df <- data.frame("data_set"=c("Sex", "Sex", "KAT6A", "KAT6A", "Weaver","Sotos" ),
                                  ...
                                  "start"=c(71.45e6, 84.302e6 , 46.6e6 ,82e6 ,27.15e6 ,140.09e6 ),
                                  "stop"=c(71.55e6, 84.305e6 , 46.72e6, 85e6 , 27.25e6 , 140.99e6 ),
                                  "fig_height"=c(8,8,8,8,8,8),
                                  "fig_width"=c(8,3,8,8,8,8))
...
for(region_id in 1:nrow(data_set_regions_df)){
  ...
  png(file=filename, width = data_set_regions_df$fig_width, height = data_set_regions_df$fig_height, units = "in", res = 320)
  ...
  png(file=filename, width = data_set_regions_df$fig_width+2, height = data_set_regions_df$fig_height, units = "in", res = 320)
  grid.newpage()
  grid.draw(gtable)
  dev.off()
...
temp_tree$children[c(1:48,50)] <- NULL
temp_tree$children[[1]]$children[[1]]$children[[2]]$children[c(1:25,28:51)] <- NULL
temp_tree$children[[1]]$children[[1]]$children[[2]]$children[[1]]$children[c(seq(2,28,by=2),5,9,11,13,15,19,25 )] <- NULL
temp_tree$children[[1]]$children[[1]]$children[[2]]$children[[2]]$children[c(seq(2,18,by=2),5,9,13,17 )] <- NULL

temp_tree <- temp_tree$children[[1]]$children[[1]]
