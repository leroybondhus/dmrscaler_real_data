...
targets <- targets[intersect(union(grep("Weaver", targets$Sample_Group),grep("Control", targets$Sample_Group)), grep("blood", targets$X)),]
...
```{r Save Data Objects}
save(GRset.funnorm, file="/home/lbondhus/Desktop/PROJECTS/dmrscaler_real_data/intermediate_data/Weaver_GRset.funnorm.Rdata")
```
