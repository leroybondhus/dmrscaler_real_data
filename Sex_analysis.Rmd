...
displayPars(itrack) <- list(cex=3,cex.bands=2, fontcolor="grey20")
 ...
 # png(filename = filename, width = 600, height=200)
  ...
  png(filename = filename, width = 600, height=500)
...
temp <- diagonalNetwork(List = x_dmr_tree_clean, fontSize = 18, fontFamily = "bold", nodeStroke = "black", linkColour = "black", opacity = 1,  margin=0, height = 800, width = 1000)
saveNetwork(temp,"/home/lbondhus/Desktop/PROJECTS/dmrscaler_real_data/figures/SEX/X_chrom_dmrs_diagonalNetwork.html" , selfcontained = T )
webshot("/home/lbondhus/Desktop/PROJECTS/dmrscaler_real_data/figures/SEX/X_chrom_dmrs_diagonalNetwork.html",
        "/home/lbondhus/Desktop/PROJECTS/dmrscaler_real_data/figures/SEX/X_chrom_dmrs_diagonalNetwork.png",
        vheight = 800, vwidth = 1000, zoom =4 )
