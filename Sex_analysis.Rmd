...
displayPars(itrack) <- list(cex=1,cex.bands=1, fontcolor="grey20")
  ...
  filename=paste("/home/lbondhus/Desktop/PROJECTS/dmrscaler_real_data/figures/SEX/FINAL_", chr,"_" ,start, "_", stop, ".png", sep = "")
  png(file=filename, width = 4, height = 6, units = "in", res = 450) ####### start writing 
  ...
  plotTracks(list(itrack, gtrack, raw_beta_track, norm_beta_track, grtrack,
             ...
             from = start-1, to=stop+1, sizes =c(0.5,0.5,1,4,2,0.3,0.3,0.3,0.3,0.3),
 ...
 # png(filename = filename, width = 600, height=200)
  ...
  png(filename = filename, width = 7, height = 6, units = "in", res = 320)
...
temp <- diagonalNetwork(List = x_dmr_tree_clean, fontSize = 24, fontFamily = "bold", nodeStroke = "black", linkColour = "black", opacity = 1,  margin=0, height = 800, width = 1200)
saveNetwork(temp,"/home/lbondhus/Desktop/PROJECTS/dmrscaler_real_data/figures/SEX/FINAL_Auto_chrom_dmrs_diagonalNetwork.html" , selfcontained = T )
webshot("/home/lbondhus/Desktop/PROJECTS/dmrscaler_real_data/figures/SEX/FINAL_Auto_chrom_dmrs_diagonalNetwork.html",
        "/home/lbondhus/Desktop/PROJECTS/dmrscaler_real_data/figures/SEX/FINAL_Auto_chrom_dmrs_diagonalNetwork.png",
        vheight = 800, vwidth = 1200, zoom =4 )
...
png("/home/lbondhus/Desktop/PROJECTS/dmrscaler_real_data/figures/SEX/Hilbert_curves_chr1.png", width = 3, height=3, units = "in", res=400)
